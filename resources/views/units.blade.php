...
<body class="bg-nature-light">
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="flex flex-col space-y-6">
            ...
            <a href="units.html" class="text-primary font-medium transition-colors text-lg py-2 nav-link active">Unit Usaha</a>
            <a href="documents.html" class="text-gray-700 hover:text-primary font-medium transition-colors text-lg py-2 nav-link">Dokumentasi</a>
        </div>
    ...
    <nav id="navbar" class="sticky-nav scroll-down py-4 transition-all duration-300">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="units.html" class="text-primary font-medium transition-colors nav-link active">Unit Usaha</a>
                <a href="documents.html" class="text-gray-700 hover:text-primary font-medium transition-colors nav-link">Dokumentasi</a>
            </div>
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            ...
            navLinks.forEach(link => {
                ...
                if (link.getAttribute('href') === `#${current}` || (link.getAttribute('href') === 'units.html' && current === 'unit-list')) {
