...
@section('title', 'Tambah Unit Usaha - Admin')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-green-100 overflow-hidden mb-8 village-card">
        <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
            ...
            <p class="text-green-100 mt-1">Tambahkan unit usaha baru ke dalam sistem BUMDes Juron</p>
        </div>
                ...
                <div class="bg-green-50 rounded-lg p-6 border border-green-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="order_num" id="order_num" value="{{ old('order_num', 1) }}" 
                ...
                <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" 
                                  class="village-textarea" placeholder="Jelaskan secara detail tentang unit usaha ini..." required>{{ old('description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-purple-50 rounded-lg p-6 border border-purple-200">
                    ...
                    <div class="text-center">
                        <div id="icon-preview" class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                            <i id="icon-display" class="fas fa-store text-white text-2xl"></i>
                        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-center border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors icon-suggestion">
                    ...
                    <p class="text-xs text-gray-600">fas fa-volume-up</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-4 text-center border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors icon-suggestion">
