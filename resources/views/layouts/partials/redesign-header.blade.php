    ...
    <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="#kontak" class="text-gray-700 hover:text-primary font-semibold transition-colors duration-300">Kontak</a>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4 border-t border-gray-200">
            <div class="flex flex-col space-y-4 pt-4">
                ...
                <a href="#kontak" class="text-gray-700 hover:text-primary font-medium transition-colors duration-300">Kontak</a>
            </div>
        </div>
    </div>
</nav>
